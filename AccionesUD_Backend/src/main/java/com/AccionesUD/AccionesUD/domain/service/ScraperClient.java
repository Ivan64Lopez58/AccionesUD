...
public class ScraperClient {
    ...
    public String obtenerDatosScraper(List<Map<String, String>> acciones) {
        String url = "http://scraper:8000/scrap";
        ...
        try {
            ...
            return "{\"error\": \"No se pudo obtener respuesta del microservicio scraper\"}";
        }
    }
}
